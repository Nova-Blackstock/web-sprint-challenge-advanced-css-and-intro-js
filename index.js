...
function changeName (index, namechange){
  artists[index].name = namechange
  return artists[index].name
}
console.log(changeName(9, 'Vincent Van Gogh'))
 ...
 *  will continuously remove artists from the array until there are none left. If you refresh your browser, the data will reset.  
*/
...
function addArtist(myarr){
    artists.push(myarr);
    return artists
  }
console.log(addArtist({id: 21, name: 'Nova Blackstock', years: '1991-present', genre: 'Neo-Baroque', nationality: 'USA', bio: 'I am an artist. I am so artisty that I was added into this array of significant artists'}));
